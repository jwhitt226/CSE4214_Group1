...
This document is divided into five numbered sections, with several subsections within each section. Sections are denoted by a primary header with a single number and the focus of the section (example: 1. Introduction). Subsections are identified by secondary header with a combination of section number, a sequential decimal, and the focus of the subsection (example: 1.2 Document Conventions). Body text is written in size eleven, arial font. System features are listed in no particular order, and all features are considered of equal priority. There are no acronyms or abbreviations used repeatedly throughout the document. 
## 1.3 Intended Audience and Reading
This document is primarily written for the CSE 4214 Group 1 development team, with additional relevance to faculty and teaching assistants overseeing the project. The sections in this document are arranged in a logical order that is likely preferred to the general reader, however some more technical information may be considerably more valuable to particular subgroups of readers. It is still advised that all readers review section two of this document, which provides a product description, encompassing functions, user classes, and product restraints. The bulk of the software architecture can be derived from sections three and four, where system features and nonfunctional requirements are detailed. These sections are expected to serve as crucial references for the development team and provide ongoing guidance as the project evolves. Section five covers miscellaneous requirements which did not fall into either of the two other categories.
## 1.4 Product Scope
...
### 3.1.2 User Story
As an admin, I want to be able to manage sellers, manage listings, remove accounts and authorize return requests.
### 3.1.3 Stimulus
...
- 3.1.4.1	The admin will be able to accept sellers.
- 3.1.4.2	The admin will be able to decline sellers.
- 3.1.4.3	The admin will be able to remove sellers.
- 3.1.4.4	The admin will be able to remove listings.
- 3.1.4.5	The admin will be able to remove accounts.
- 3.1.4.6	The admin will be able to authorize return requests.
...
### 3.2.2 User Story
As a seller, I want to be able to veiw, remove and add listings.
### 3.2.3 Stimulus
The seller should be able to post and remove different book listings as well as view their current listings.
### 3.2.4 Functional Requirements
- 3.2.4.1	The seller should be able to view their current listings.
- 3.2.4.2	The seller should be able to remove listings.
- 3.2.4.3	The seller should be able to add listings.
## 3.3 Profile Management
### 3.3.1 Description
Allow the user to edit their profile information and apply to be a seller in the system.
### 3.3.2 User Story
As a user, I want to be able to edit my profile information at any time. Through this menu, I should also be able to apply to be a seller.
### 3.3.3 Stimulus
...
- 3.3.4.1	Allow the user to edit their profile information.
- 3.3.4.2	Allow the user to apply to be a seller.
...
### 3.4.2 User Story
As a user, I want to be able to register an account to this website that I can log into when I use the website.
#### 3.4.3 Stimulus
...
- 3.4.4.1	The system should display a screen for the user to enter their email address, name, mailing address, password, and payment information. 
- 3.4.4.2	The system should store the user’s information in a secure database.
- 3.4.4.3	The system should validate the admin code and register the user as an admin if necessary.
- 3.4.4.4	The system shouldn’t allow the user to register without filling in the email address, password, mailing address, and payment information fields.
- 3.4.4.5	The system should display a login screen with input boxes for email and password, as well as a login button.
- 3.4.4.6	The system should validate and email and password pair and throw an error if invalid.
## 3.5 Browse Listings
### 3.5.1 Description
...
### 3.5.2 User Story
As a customer, I want to be able to find the book I am looking for by searching for it by title, author, or ISBN number. I also want to be able to browse by genre, and when I find a book that I am interested in, I would like to be able to view it for more information.
### 3.5.3 Stimulus
...
- 3.5.4.1 The system should display a search bar that the user can type in. 
- 3.5.4.2 The system should display a search button that the user can click to initiate a search. 
- 3.5.4.3 The system should provide the user with the search results. 
- 3.5.4.4 The system should display an error if there are no listings that match the user’s search. 
- 3.5.4.5 The system should also provide a menu of genres for the user to select. 
- 3.5.4.6 The system should only show items that match the genre selected by the user. 
- 3.5.4.7 The system should return search results in order with the items with the closes match with the search appearing first. 
- 3.5.4.8 The user should be able to click on a book to see more information on it. 
## 3.6 Modify Cart
### 3.6.1 Description 
...
### 3.6.2 User Story
As a customer, I would like to add items to my cart that are to be purchased later. Also I want to be able to modify my cart at any time.
### 3.6.3 Stimulus 
...
- 3.6.4.1 The user should be able to access their cart through a button. 
- 3.6.4.2 The system should allow users to add books to their cart. 
- 3.6.4.3 The system should allow the users to remove books from their cart. 
## 3.7 Checkout
### 3.7.1 Description 
...
### 3.7.2 User Story
As a customer, I want to be able to purchase all items in my cart whenever I am ready.
### 3.7.3 Stimulus
...
- 3.7.4.1 User will be able to access checkout menu through a button. 
- 3.7.4.2 User will be able to place order via a button. 
- 3.7.4.3 System will be able to calculate and provide estimated total. 
- 3.7.4.4 System will be able to verify payment method. 
- 3.7.4.5 System will be able to pass order to the necessary sellers. 
- 3.7.4.6 System will be able to manipulate inventory accordingly. 
## 3.8 Return Items
### 3.8.1	Description  
...
### 2.8.2 User Story
As a customer, I want to be able to return any items recently purchased and recieve a full refund.
### 3.8.3	Stimulus
...
- 3.8.4.1 User should be able to submit a return request. 
- 3.8.4.2 Seller should be able to confirm receipt of the return. 
- 3.8.4.3 User should be refunded  via store credit. 
...
In order for *Bookaholics* to be fully functional, it would require integration with third party systems such as payment gateways and shipping carriers. This would facilitate secure online transactions and safe delivery of orders, however that likely falls outside of the scope of this project. 
